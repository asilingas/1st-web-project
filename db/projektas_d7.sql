...
--
-- Host: localhost:3306
-- Generation Time: Feb 18, 2019 at 04:05 PM
...
(6, 'Testas', 'test@testas.lt', 'Testinis klausimas?', '2019-02-18 11:57:49'),
(7, 'Bla', 'bla@bla.lt', 'Bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla', '2019-02-18 12:00:42'),
(10, 'Testas', 'testas@testt.lt', 'Test klausimasTest klausimasTest klausimasTest klausimasTest klausimasTest klausimasTest klausimasTest klausimass test test test test test test test test test test test test test test test test test test test test test test test', '2019-02-18 12:12:39');
...
(3, '2019-02-18 11:29:33', 'topas@delfi.lt'),
(4, '2019-02-18 11:34:02', 'testas@test.lt'),
(5, '2019-02-18 11:34:24', 'testas@test.lt'),
(6, '2019-02-18 14:24:27', 'greja10@gmail.com'),
(7, '2019-02-18 15:07:31', 'topas@delfi.lt');
...
(19, 'Testas', 'Testaitis', 'test@test.lt', 'Testo g. 5', 22224, 'Kaunas', '37060099999', 2, '2019-02-18 11:21:17', 5, '25.49'),
(20, 'Jonas', 'Jonaitis', 'jonas@jonas.lt', 'Jono g. 5', 11111, 'Kaunas', '37069900000', 1, '2019-02-18 11:23:47', 10, '11.50'),
(21, 'Artūras', 'Šilingas', 'mayoctt@gmail.com', 'S. Žukausko g. 5-22', 49405, 'Kaunas', '37067542023', 3, '2019-02-18 13:33:43', 9, '22.99'),
(22, 'tomastomsonas1234@gmail.com', 'Tomas9', 'tomastomsonas1234@gmail.com', 'tomastomsonas1234@gmail.com', 22222, 'Kaunas', '12321321', 2, '2019-02-18 15:12:20', 3, '16.49');
...
(18, 'Paveikslas žemėlapis: Kaunas', 'Paveikslas žemėlapis: Kaunas su rėmeliais, paveikslas atspausdintas ant aukštos kokybės ofsetinio popieriaus.', '15.50', '30x40', 'Lietuvos', 1, 'kaunas', '2019-02-18 11:18:01');
...
(36, 'testas@test.lt', '99f97d455d5d62b24f3a942a1abc3fa8863fc0ce2037f52f09bd785b22b800d4f2e7b2b614cb600ffc2a4fe24679845b24886d69bb776fcfa46e54d188889c6f', 'Test', 'Test', 'Test', '24222', 'Test', '2019-02-18 15:05:57', 0),
(37, 'testas@gmail.com', '52b526411070a0a92075ea7c2575f759f480f2f4788d56300091696fc7eabb71a74a5fbca04b1934e215ca00bb6b977f6069a34588caa81f622616caacbc83bf', '', '', '', '', '', '2019-02-18 15:06:42', 0);
...
--
ALTER TABLE `orders`
  MODIFY `id` smallint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
